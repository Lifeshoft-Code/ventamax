...
import Style from '../../../styles/Component/ProductControl/ProductControl.module.css'
import SearchBar_Product from '../../component/inputs/SearchBar_Product'
import Button from '../btns/Btn_m'
const Control_search_product = (props) => {
  return (
  
   <div className={Style.Container}>
     <SearchBar_Product placeholder='Buscar por ( Nombre o Codigo de Barra)'></SearchBar_Product>
...
export default Control_search_product